...
ADMINS = list(map(int, os.environ.get('ADMINS', '5560200410').split()))
if not ADMINS:
...
mongo_url = os.environ.get('MONGO_URL', 'mongodb+srv://muktarhussainff5:3ChQSSJmaCri2LLi@cluster0.pykyf.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0')
...
async def start_command(client, message):
    ...
    sticker_message = await message.reply_sticker("CAACAgUAAxkBAAIyLGgFHwOBCV0R3r21Rx4P10F904sYAAJyFAACMjMIVvVXaR6omBBBHgQ")
    ...
    if verify_status["is_verified"]:
        ...
        join_button = InlineKeyboardButton("Join ❤️🚀", url="https://t.me/tate_botX")
        developer_button = InlineKeyboardButton("Developer ⚡️", url="https://t.me/Mr_mark_tate")
